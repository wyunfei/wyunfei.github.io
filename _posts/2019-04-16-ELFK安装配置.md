...
[完整配置文件](/assets/file/elk/elasticsearch.yml)
...
server.host: "0.0.0.0"
```
[完整配置文件](/assets/file/elk/kibana.yml)
...
```
[完整配置文件](/assets/file/elk/logstash-kafka.conf)
...
```
[完整配置文件](/assets/file/elk/filebeat.yml)
